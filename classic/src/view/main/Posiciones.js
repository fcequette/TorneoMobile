 ...
 */
Ext.define('Torneo.view.main.Posiciones', {
    extend: 'Ext.container.Container',
    xtype: 'posiciones',
    title:'Posiciones',
    style:'background-color:#58833e',
    // requires: [
    //
    // ],
    width:'100%',
   ...
   // modal: true,
    ...
    items:[{
        ...
        ,store: 'Posiciones'
        ,columns: [
          { text: '', dataIndex: 'pos', width:window.innerWidth*0.15,sortable: false,align:'center'},
           { text: 'Id  ', dataIndex: 'equipo_id', width: window.innerWidth*0.15,hidden:true},
           { text: 'Equipo  ', dataIndex: 'equipo_nombre', width:window.innerWidth*0.45,sortable: false ,align:'center'},
           { text: 'Ptos',  dataIndex: 'ptos', width:window.innerWidth*0.2,sortable: false,align:'center'  },
           ...
           { text: 'Dif ', dataIndex: 'dif', width: window.innerWidth*0.2,sortable: false,align:'center' }
        ]
      }]
});
